...
namespace Quantum {
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct GameData : Quantum.IComponentSingleton {
    public const Int32 SIZE = 4;
    public const Int32 ALIGNMENT = 4;
    [FieldOffset(0)]
    [AllocateOnComponentAdded()]
    [FreeOnComponentRemoved()]
    public QListPtr<EntityRef> playerList;
    public override Int32 GetHashCode() {
      unchecked { 
        var hash = 2767;
        hash = hash * 31 + playerList.GetHashCode();
        return hash;
      }
    }
    public void ClearPointers(FrameBase f, EntityRef entity) {
      if (playerList != default) f.FreeList(ref playerList);
    }
    public static void OnRemoved(FrameBase frame, EntityRef entity, void* ptr) {
      var p = (Quantum.GameData*)ptr;
      p->ClearPointers((Frame)frame, entity);
    }
    public void AllocatePointers(FrameBase f, EntityRef entity) {
      f.TryAllocateList(ref playerList);
    }
    ...
    public static void Serialize(void* ptr, FrameSerializer serializer) {
        var p = (GameData*)ptr;
        QList.Serialize(&p->playerList, serializer, Statics.SerializeEntityRef);
    }
  }
  [StructLayout(LayoutKind.Explicit)]
  ...
  public unsafe partial interface ISignalOnCollisionProjectileHitPlayer : ISignal {
    void OnCollisionProjectileHitPlayer(Frame f, CollisionInfo2D info, Projectile* projectile, Weapon* player);
  }
  public unsafe partial interface ISignalOnCollisionProjectileHitProjectile : ISignal {
    void OnCollisionProjectileHitProjectile(Frame f, CollisionInfo2D info, Projectile* projectile, Projectile* otherProjectile);
  }
  public unsafe partial interface ISignalOnCollisionPlayerHitOtherPlayer : ISignal {
    void OnCollisionPlayerHitOtherPlayer(Frame f, CollisionInfo2D info, Weapon* player, Weapon* otherPlayer);
  }
  public static unsafe partial class Constants {
  }
  public unsafe partial class Frame {
    private ISignalWeaponProjectileShoot[] _ISignalWeaponProjectileShootSystems;
    private ISignalOnCollisionProjectileHitPlayer[] _ISignalOnCollisionProjectileHitPlayerSystems;
    private ISignalOnCollisionProjectileHitProjectile[] _ISignalOnCollisionProjectileHitProjectileSystems;
    private ISignalOnCollisionPlayerHitOtherPlayer[] _ISignalOnCollisionPlayerHitOtherPlayerSystems;
    ...
    partial void InitGen() {
      ...
      _ISignalWeaponProjectileShootSystems = BuildSignalsArray<ISignalWeaponProjectileShoot>();
      _ISignalOnCollisionProjectileHitPlayerSystems = BuildSignalsArray<ISignalOnCollisionProjectileHitPlayer>();
      _ISignalOnCollisionProjectileHitProjectileSystems = BuildSignalsArray<ISignalOnCollisionProjectileHitProjectile>();
      _ISignalOnCollisionPlayerHitOtherPlayerSystems = BuildSignalsArray<ISignalOnCollisionPlayerHitOtherPlayer>();
      ...
      BuildSignalsArrayOnComponentAdded<Quantum.GameData>();
      BuildSignalsArrayOnComponentRemoved<Quantum.GameData>();
    ...
    public unsafe partial struct FrameSignals {
      public void WeaponProjectileShoot(EntityRef owner, FPVector2 spawnPosition, AssetRef<EntityPrototype> projectilePrototype) {
        var array = _f._ISignalWeaponProjectileShootSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.WeaponProjectileShoot(_f, owner, spawnPosition, projectilePrototype);
          }
        }
      }
      public void OnCollisionProjectileHitPlayer(CollisionInfo2D info, Projectile* projectile, Weapon* player) {
      ...
      public void OnCollisionProjectileHitProjectile(CollisionInfo2D info, Projectile* projectile, Projectile* otherProjectile) {
        var array = _f._ISignalOnCollisionProjectileHitProjectileSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnCollisionProjectileHitProjectile(_f, info, projectile, otherProjectile);
          }
        }
      }
      public void OnCollisionPlayerHitOtherPlayer(CollisionInfo2D info, Weapon* player, Weapon* otherPlayer) {
        var array = _f._ISignalOnCollisionPlayerHitOtherPlayerSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.OnCollisionPlayerHitOtherPlayer(_f, info, player, otherPlayer);
          }
        }
      }
    }
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.GameData), Quantum.GameData.SIZE);
